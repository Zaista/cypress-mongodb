...
export function deleteOne(pipeline: Document, collection?: string, database?: string): Chainable {
...
export function deleteMany(pipeline: Document[], collection?: string, database?: string): Chainable {
